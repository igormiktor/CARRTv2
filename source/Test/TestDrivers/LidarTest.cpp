...
void doInstructions()
{
    laptop.println( "Lidar ranging test..." );
    laptop.println( "Enter a (or A) followed by relative azimuth to slew the Lidar" );
...
void doSlew( char* token )
{
    ...
    if ( token )
    {
        ...
        {
            Lidar::slew( bearing );
            laptop.print( "Lidar slewed to azimuth:  " );
