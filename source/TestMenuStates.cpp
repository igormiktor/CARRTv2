...
namespace
{
    ...
    const PROGMEM char sTestMenuItem14[] = "Gyroscope";
    const PROGMEM char sTestMenuItem15[] = "Drive Fwd/Rev";
    const PROGMEM char sTestMenuItem16[] = "Drive Left/Right";
    const PROGMEM char sTestMenuItem17[] = "Error Handling";
